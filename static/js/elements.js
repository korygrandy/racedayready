...
export const devModeBtn = document.getElementById('dev-mode-btn');
export const backToAppBtn = document.getElementById('back-to-app-btn');
export const mainView = document.getElementById('main-view');
export const developerView = document.getElementById('developer-view');
export const featuresView = document.getElementById('features-view');
export const featuresHelmetDisplay = document.getElementById('features-helmet-display');
...
export const featureCard8 = document.getElementById('feature-card-8');
export const featureCard9 = document.getElementById('feature-card-9'); // Track Management
...
export const featureRequestTextarea = document.getElementById('feature-request-textarea');
...
export const eventVehiclesContainer = document.getElementById('event-vehicles-container');
export const eventChecklistsSelect = document.getElementById('event-checklists-select');
export const eventTrackSelect = document.getElementById('event-track-select');
...
export const editEventVehiclesContainer = document.getElementById('edit-event-vehicles-container');
export const editEventChecklistsSelect = document.getElementById('edit-event-checklists-select');
export const editEventTrackSelect = document.getElementById('edit-event-track-select');
...
export const helmetColorInput = document.getElementById('helmet-color-input');
export const themeSelect = document.getElementById('theme-select');
export const enablePinCheckbox = document.getElementById('enable-pin-checkbox');
export const pinInput = document.getElementById('pin-input');
...
export const selectProfileModal = document.getElementById('select-profile-modal');
...
export const confirmationModalCancelBtn = document.getElementById('confirmation-modal-cancel-btn');
export const confirmationModalConfirmBtn = document.getElementById('confirmation-modal-confirm-btn');

export const pinEntryModal = document.getElementById('pin-entry-modal');
export const pinEntryText = document.getElementById('pin-entry-text');
export const pinEntryForm = document.getElementById('pin-entry-form');
export const pinEntryInput = document.getElementById('pin-entry-input');
export const cancelPinEntryBtn = document.getElementById('cancel-pin-entry-btn');

export const devPinEntryModal = document.getElementById('dev-pin-entry-modal');
export const devPinEntryForm = document.getElementById('dev-pin-entry-form');
export const devPinEntryInput = document.getElementById('dev-pin-entry-input');
export const cancelDevPinBtn = document.getElementById('cancel-dev-pin-btn');

export const pinSettingsModal = document.getElementById('pin-settings-modal');
export const pinSettingsHeading = document.getElementById('pin-settings-heading');
export const pinSettingsForm = document.getElementById('pin-settings-form');
export const editEnablePinCheckbox = document.getElementById('edit-enable-pin-checkbox');
export const editPinInput = document.getElementById('edit-pin-input');
export const cancelPinSettingsBtn = document.getElementById('cancel-pin-settings-btn');
export const savePinSettingsBtn = document.getElementById('save-pin-settings-btn');
...
export const trackManagementView = document.getElementById('track-management-view');
export const addTrackForm = document.getElementById('add-track-form');
export const trackNameInput = document.getElementById('track-name-input');
export const trackLocationInput = document.getElementById('track-location-input');
export const trackTypeSelect = document.getElementById('track-type-select');
export const trackGoogleUrlInput = document.getElementById('track-google-url-input');
export const trackPhotoInput = document.getElementById('track-photo-input');
export const trackPhotoUrlInput = document.getElementById('track-photo-url-input');
export const trackPhotoPreview = document.getElementById('track-photo-preview');
export const trackLayoutPhotoInput = document.getElementById('track-layout-photo-input');
export const trackLayoutPhotoUrlInput = document.getElementById('track-layout-photo-url-input');
export const trackLayoutPhotoPreview = document.getElementById('track-layout-photo-preview');
export const addTrackBtn = document.getElementById('add-track-btn');
export const trackList = document.getElementById('track-list');
export const backToFeaturesFromTrackBtn = document.getElementById('back-to-features-from-track-btn');

// Edit Track Modal Elements
export const editTrackModal = document.getElementById('edit-track-modal');
export const editTrackForm = document.getElementById('edit-track-form');
export const editTrackNameInput = document.getElementById('edit-track-name-input');
export const editTrackLocationInput = document.getElementById('edit-track-location-input');
export const editTrackTypeSelect = document.getElementById('edit-track-type-select');
export const editTrackGoogleUrlInput = document.getElementById('edit-track-google-url-input');
export const editTrackPhotoInput = document.getElementById('edit-track-photo-input');
export const editTrackPhotoUrlInput = document.getElementById('edit-track-photo-url-input');
export const editTrackPhotoPreview = document.getElementById('edit-track-photo-preview');
export const editTrackLayoutPhotoInput = document.getElementById('edit-track-layout-photo-input');
export const editTrackLayoutPhotoUrlInput = document.getElementById('edit-track-layout-photo-url-input');
